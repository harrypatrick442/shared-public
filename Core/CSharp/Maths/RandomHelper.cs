...
namespace Core.Maths {
    public static class RandomHelper {
        ...
        public static double NextDouble(double minValueInclusive, double maxValueExclusive)
        {
            return _Random.NextDouble() * (maxValueExclusive - minValueInclusive) + minValueInclusive;
        }
