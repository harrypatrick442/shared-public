...
namespace TapoDevices
{
    ...
    {
        private readonly TapoCredentials _Credentials;
        ...
        public TapoDevice(
            string ipAddress,
            TapoCredentials credentials) 
            : this(ipAddress, credentials, TimeSpan.FromSeconds(5))
        {
        ...
        public async Task ConnectAsync()
        {
            ...
            var r = await this._Client.PostAsync("handshake1", new ByteArrayContent(localSeed));
            ...
            var localAuthHash = CreateAuthHash(_Credentials.Username, _Credentials.Password);
            ...
            if (Utils.ByteArraysEqual(localSeedAuthHash, serverHash))
            {
                ...
                var response2 = await this._Client.PostAsync("handshake2", new ByteArrayContent(payload));
        ...
        public async Task ConnectOldAsync()
        {
            ...
            var hashedUsername = SHA1.HashData(Encoding.UTF8.GetBytes(_Credentials.Username));
            ...
            var loginRequest = LoginDevice.CreateRequest(new LoginDevice.Params
            {
                ...
                Password = Convert.ToBase64String(Encoding.UTF8.GetBytes(_Credentials.Password), Base64FormattingOptions.InsertLineBreaks),
            });
        ...
        public async Task<DeviceInfo> GetInfoAsync()
        {
            ...
            return await PostSecuredAsync<TapoRequest<GetDeviceInfo.Params>, DeviceInfo>(request);
        }
        ...
        protected async Task<TResult> PostSecuredAsync<TRequest, TResult>(TRequest request)
        {
            ...
            if (this.klapSession != null)
            {
                ...
                var response = await this._Client.PostAsync("request?seq=" + this.klapSession.SeqCounter, new ByteArrayContent(payload));
