...
namespace TapoDevices.DeviceInfos
{
    ...
    public class DeviceInfo
    {
        ...
        [JsonIgnore]
        public string SSID => Encoding.UTF8.GetString(Convert.FromBase64String(SSIDEncoded));
        ...
        [JsonIgnore]
        public string Nickname => Encoding.UTF8.GetString(Convert.FromBase64String(NicknameEncoded));
